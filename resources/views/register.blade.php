                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-md-3 col-lg-3">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a class="wallet-img" href="#">Convert</a>
                                </li>
                                <!-- <li>
                                    <a class="wallet-img" href="{{ url('/') }}/my-offers">My offers</a>
                                </li> -->
                            </ul>
                        </div>
                        <div class="col-sm-3 col-md-3 col-lg-3">
                            ...
                            <ul>
                                <li>
                                    <a class="wallet-img" href="faq">FAQ's</a>
                                </li>
                                <li>
                        ...
                        <div class="col-sm-3 col-md-3 col-lg-3">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a class="wallet-img" href="#">Affiliate</a>
                                </li>
                            </ul>
                        </div>
                    </div>
