                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" autocomplete="new-username" id="uname" name="user_name" placeholder="Username">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="control-label">Password*</label>
                                    <input type="password" class="form-control" autocomplete="new-password" id="pass" name="password" placeholder="Password">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <p><a href="forgot" class="ml-auto">Forgot Password ?</a></p>
                                </div>
                            </div>
                            <div class="col-12 mt-3">
                                <button type="submit" id='login' class="btn-login font-14 btn-block">Login</button>
                            </div>
                        </div>
                    </form>
	            </div>
         ...
         <script type="text/javascript">
             $(document).ready(function(){
                $('#login').click(function(){
                    ...
                    if (username=='') {
                        toastr.error("Username not entered. Please enter Username to login.");
                        return false;
                    }
                    else if(pass ==''){
                        toastr.error("Password not entered. Please enter Password to login.");
                        return false;
                    }
